...
SECRET_KEY = '^z-wv8uvgu7cvp-ru#39%6(0d31-q6--)n!^(ai&3n1a%ehtrj'
...
WSGI_APPLICATION = 'qrtoolkitdordrecht.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'qrtoolkit_core/static')
STATIC_URL = '/static/'
